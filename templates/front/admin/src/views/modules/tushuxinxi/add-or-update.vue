<template>
	<div class="addEdit-block" :style='{"padding":"30px"}'>
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="图书名称" prop="tushumingcheng">
					<el-input v-model="ruleForm.tushumingcheng" placeholder="图书名称" clearable  :readonly="ro.tushumingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="图书名称" prop="tushumingcheng">
					<el-input v-model="ruleForm.tushumingcheng" placeholder="图书名称" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="图书分类" prop="tushufenlei">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="图书分类" prop="tushufenlei">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="作者" prop="zuozhe">
					<el-input v-model="ruleForm.zuozhe" placeholder="作者" clearable  :readonly="ro.zuozhe"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="作者" prop="zuozhe">
					<el-input v-model="ruleForm.zuozhe" placeholder="作者" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="出版社" prop="chubanshe">
					<el-input v-model="ruleForm.chubanshe" placeholder="出版社" clearable  :readonly="ro.chubanshe"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="出版社" prop="chubanshe">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-if="type!='info'"  label="图书详情" prop="tushuxiangqing">
					<editor 
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.tushuxiangqing" label="图书详情" prop="tushuxiangqing">
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.tushuxiangqing = this.ruleForm.tushuxiangqing.replace(reg,'../../../django0uys6855/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
