  ...
  <div :style='{"padding":"20px 30px","background":"#f9fbfd","flexDirection":"column","display":"flex"}'>
    ...
    >  
     <el-row>
        ...
        <el-form-item :style='{"margin":"0 0 20px 0"}'   v-if="flag=='yonghu'"  label="图书分类" prop="tushufenlei">
          <el-input v-model="ruleForm.tushufenlei"               placeholder="图书分类" clearable></el-input>
        </el-form-item>
