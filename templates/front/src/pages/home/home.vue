...
<!-- 商品推荐 -->
<div id="animate_recommendtushuxinxi" class="recommend animate__animated" :style='{"width":"80%","margin":"0 auto","position":"relative","background":"#fff","order":"2"}'>
    ...
    <div class="title" :style='{"margin":"10px 0","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231122/a500d6f740e5474287d3831acdce1d92.png)","width":"30%","lineHeight":"54px","backgroundSize":"contain","backgroundPosition":"left top","backgroundRepeat":"no-repeat"}'>
		<span :style='{"color":"#000","fontSize":"32px","fontWeight":"bold"}'>图书信息推荐</span>
	</div>
	...
	<div v-if="tushuxinxiRecommend.length" class="list list12 index-pv1 list12tushuxinxi" :style='{"width":"100%","padding":"10px","background":"#fff","display":"flex","height":"auto"}'>
	  <div class="list" :style='{"overflow":"hidden","flexWrap":"wrap","flex":"1","background":"#fff","display":"flex","justifyContent":"space-between","height":"auto","order":"1"}'>
	    <div :style='{"border":"1px solid #D8D8D8","width":"calc(100% / 3 - 20px)","margin":"0 0 20px","position":"relative","borderWidth":"0 0 2px","height":"auto"}' class="item list-item animation-box" v-for="item,index in tushuxinxiRecommend" :key="index" @click="toDetail('tushuxinxiDetail', item)">
			...
			<div class="line1" :style='{"padding":"0 10px","lineHeight":"32px","fontSize":"18px","color":"#000","textAlign":"center"}'>{{item.tushumingcheng}}</div>
			<div class="line1" :style='{"padding":"0 10px","lineHeight":"32px","fontSize":"18px","color":"#000","textAlign":"center"}'>作者:{{item.zuozhe}}</div>
	    </div>
	  </div>
	</div>
	...
	<div @click="moreBtn('tushuxinxi')" :style='{"border":"1px solid #9E9E9E","margin":"0 0 0 -40px","top":"22px","textAlign":"center","left":"33%","background":"none","display":"block","width":"80px","lineHeight":"32px","position":"absolute"}'>
...
<!-- 商品推荐 -->
<div id="animate_recommendtushuchanpin" class="recommend animate__animated" :style='{"width":"80%","margin":"0 auto","position":"relative","background":"#fff","order":"2"}'>
	<div v-if="false" class="idea recommendIdea" :style='{"padding":"20px","flexWrap":"wrap","background":"#efefef","justifyContent":"space-between","display":"flex"}'>
		<div class="box1" :style='{"width":"20%","background":"#fff","height":"80px"}'></div>
		<div class="box2" :style='{"width":"20%","background":"#fff","height":"80px"}'></div>
		<div class="box3" :style='{"width":"20%","background":"#fff","height":"80px"}'></div>
    ...
    <div class="title" :style='{"margin":"10px 0","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231122/a500d6f740e5474287d3831acdce1d92.png)","width":"30%","lineHeight":"54px","backgroundSize":"contain","backgroundPosition":"left top","backgroundRepeat":"no-repeat"}'>
		<span :style='{"color":"#000","fontSize":"32px","fontWeight":"bold"}'>图书产品推荐</span>
	</div>
	...
	<div v-if="tushuchanpinRecommend.length" class="list list12 index-pv1 list12tushuchanpin" :style='{"width":"100%","padding":"10px","background":"#fff","display":"flex","height":"auto"}'>
	  <div class="list" :style='{"overflow":"hidden","flexWrap":"wrap","flex":"1","background":"#fff","display":"flex","justifyContent":"space-between","height":"auto","order":"1"}'>
	    <div :style='{"border":"1px solid #D8D8D8","width":"calc(100% / 3 - 20px)","margin":"0 0 20px","position":"relative","borderWidth":"0 0 2px","height":"auto"}' class="item list-item animation-box" v-for="item,index in tushuchanpinRecommend" :key="index" @click="toDetail('tushuchanpinDetail', item)">
			<img :name="item.id" :style='{"width":"100%","objectFit":"cover","display":"block","height":"200px"}' v-if="preHttp(item.fengmian)" :src="item.fengmian.split(',')[0]" alt="" />
			<img :name="item.id" :style='{"width":"100%","objectFit":"cover","display":"block","height":"200px"}' v-else :src="baseUrl + (item.fengmian?item.fengmian.split(',')[0]:'')" alt="" />
			<div class="line1" :style='{"padding":"0 10px","lineHeight":"32px","fontSize":"18px","color":"#000","textAlign":"center"}'>{{item.chanpinmingcheng}}</div>
			<div class="line1" :style='{"padding":"0 10px","lineHeight":"32px","fontSize":"18px","color":"#000","textAlign":"center"}'>{{item.chanpinfenlei}}</div>
	    </div>
	  </div>
	</div>
	...
	<div @click="moreBtn('tushuchanpin')" :style='{"border":"1px solid #9E9E9E","margin":"0 0 0 -40px","top":"22px","textAlign":"center","left":"33%","background":"none","display":"block","width":"80px","lineHeight":"32px","position":"absolute"}'>
		<span :style='{"color":"#9E9E9E","fontSize":"12px"}'>查看更多</span>
		<i :style='{"color":"#f5f5f5","fontSize":"12px","display":"none"}' class="icon iconfont icon-gengduo1"></i>
	</div>
    ...
    methods: {
		...
		handleScroll() {
			let arr = [
				...
				{id:'animate_recommendtushuxinxi',css:'animate__'},
				{id:'animate_recommendtushuchanpin',css:'animate__'},
      ...
      preHttp(str) {
		...
		getList() {
          ...
          autoSortUrl = "tushuchanpin/autoSort";
          if(localStorage.getItem('frontToken')) {
              autoSortUrl = "tushuchanpin/autoSort2";
          }
			data = {
				page: 1,
				limit: 6,
			...
			this.$http.get(autoSortUrl, {params: data}).then(res => {
				if (res.data.code == 0) {
					this.tushuchanpinRecommend = res.data.data.list;
