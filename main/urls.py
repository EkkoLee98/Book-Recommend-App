...
from main import users_v, config_v, schema_v, Tushuxinxi_v
...
urlpatterns = [
    ...
    path(r'tushuxinxi/import', Tushuxinxi_v.import_books),
    path(r'tushuxinxi/export', Tushuxinxi_v.export_books),
    path(r'tushuxinxi/gen', Tushuxinxi_v.schemaName_spider),
...
# 批量生成数据
        ...
        if tableName.lower() == "tushuchanpin":
            urlpatterns.extend(
                [
                    path(r'{}/count'.format(tableName.lower()),
                         eval("{}_v.{}_count".format(tableName.capitalize(), tableName.lower()))),
        ...
        if tableName.lower() == "discusstushuxinxi":
            urlpatterns.extend(
                [
                    path(r'{}/security'.format(tableName.lower()),
                         eval("{}_v.{}_security".format(tableName.capitalize(), tableName.lower()))),
        ...
        if tableName.lower() == "discusstushuchanpin":
            urlpatterns.extend(
                [
                    path(r'{}/security'.format(tableName.lower()),
                         eval("{}_v.{}_security".format(tableName.capitalize(), tableName.lower()))),
...
urlpatterns.extend(
    [
        ...
        path(r'follow/<tableName>/<columnName>/<level>/<parent>',
             schema_v.schemaName_follow_level),
        ...
        path(r'remind/<tableName>/<columnName>/<type>',
             schema_v.schemaName_remind_tablename_columnname_type),
        # 前台提醒接口（通用接口，不需要登陆）
        path(r'<tableName>/remind/<columnName>/<type>',
             schema_v.schemaName_tablename_remind_columnname_type),
        # 后台提醒接口 (每个表的单独接口，需登录)
        path(r'sh/<tableName>', schema_v.schemaName_sh),
        path(r'upload/<fileName>', schema_v.schemaName_upload),
        path(r'group/<tableName>/<columnName>',
             schema_v.schemaName_group_quyu),
        path(r'value/<tableName>/<xColumnName>/<yColumnName>',
             schema_v.schemaName_value_quyu),
        path(r'value/<tableName>/<xColumnName>/<yColumnName>/<timeStatType>',
             schema_v.schemaName_value_riqitj),
