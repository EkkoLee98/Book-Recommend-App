...
class chanpinfenlei(BaseModel):
    ...
    __isAdmin__='否'#表属性isAdmin=”是”,刷出来的用户表也是管理员，即page和list可以查看所有人的考试记录(同时应用于其他表)
    addtime = models.DateTimeField(auto_now_add=False, verbose_name=u'创建时间')
    chanpinfenlei=models.CharField ( max_length=255, null=True,unique=True, verbose_name='产品分类' )
    '''
    chanpinfenlei=VARCHAR
    '''
    class Meta:
        db_table = 'chanpinfenlei'
        verbose_name = verbose_name_plural = '产品分类'
class tushuchanpin(BaseModel):
    __doc__ = u'''tushuchanpin'''
    __tablename__ = 'tushuchanpin'
    ...
    chanpinfenlei=models.CharField ( max_length=255,null=False, unique=False, verbose_name='产品分类' )
    ...
    chanpinjieshao=models.TextField   (  null=True, unique=False, verbose_name='产品介绍' )
    zhanghao=models.CharField ( max_length=255, null=True, unique=False, verbose_name='账号' )
    nicheng=models.CharField ( max_length=255, null=True, unique=False, verbose_name='昵称' )
    shouji=models.CharField ( max_length=255, null=True, unique=False, verbose_name='手机' )
    ...
    '''
    class Meta:
        db_table = 'tushuchanpin'
        verbose_name = verbose_name_plural = '图书产品'
...
class discusstushuchanpin(BaseModel):
    __doc__ = u'''discusstushuchanpin'''
    __tablename__ = 'discusstushuchanpin'
    ...
    '''
    class Meta:
        db_table = 'discusstushuchanpin'
        verbose_name = verbose_name_plural = '图书产品评论表'
